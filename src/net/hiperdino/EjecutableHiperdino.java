...
public class EjecutableHiperdino {
    public static void main(String[] args) {
        ...
        while (!salir) {
            ...
            switch (opcion) {
                ...
                case 2:
                    if (cajaAbierta) {
                        Cliente nuevoCLiente = new Cliente(NombreAleatorio.obtenerNombreAleatorio());
                ...
                case 4:
                    if (cajero.hayClientesEnCola()) {
                        System.out.println("Clientes en la cola del cajero "+ cajero.idCaja());
